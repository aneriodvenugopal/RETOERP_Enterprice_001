...
user_problem_statement: "Fix critical bugs and implement feature updates for RETOERP PWA: PHASE 1 CRITICAL FIXES: (1) Authentication persistence - users asked to login repeatedly in PWA for both RETOERP and IncomeLands apps, should stay logged in until explicit logout, (2) Page scroll issue - pages opening at bottom instead of top (e.g., Pricing page), (3) Emergent branding removal - emergent tracking scripts and links showing in deployed PWA at https://retoerp.com/, (4) Advisory loading optimization - takes too long to show results, need to optimize and show loading message 'Our Expert team is working on it...'. PHASE 2 FEATURE UPDATES: (5) Rename 'FREE AI ADVISORY' to 'FREE 24X7 Expert Advisory' everywhere (homepage, footer, all pages), add good description, add button to homepage and footer, (6) Add language selection (Telugu, English, Hindi) in each advisory, (7) Location-wise advisory improvements, (8) Plot booking payment acceptance from Project, (9) Policy pages (Cancellation, Refund, Privacy, Terms, Contact, Shipping) with links in footer."
