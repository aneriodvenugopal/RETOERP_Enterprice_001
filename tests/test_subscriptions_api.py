...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://realestate-mgmt-9.preview.emergentagent.com')
    ...
    def test_create_checkout_session_monthly(self):
        ...
        response = requests.post(
            ...
            json={
                ...
                "origin_url": "https://realestate-mgmt-9.preview.emergentagent.com"
            }
        )
        assert response.status_code == 200
