...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://plotmaster-10.preview.emergentagent.com/login")
    print("   Properties: https://plotmaster-10.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://plotmaster-10.preview.emergentagent.com/customer-dashboard")
