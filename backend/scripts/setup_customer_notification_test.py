...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://retoerp-realtor.preview.emergentagent.com/login")
    print("   Properties: https://retoerp-realtor.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://retoerp-realtor.preview.emergentagent.com/customer-dashboard")
