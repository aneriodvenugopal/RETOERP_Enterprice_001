...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://retoerp-1.preview.emergentagent.com/login")
    print("   Properties: https://retoerp-1.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://retoerp-1.preview.emergentagent.com/customer-dashboard")
