...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://propertysuite-3.preview.emergentagent.com/login")
    print("   Properties: https://propertysuite-3.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://propertysuite-3.preview.emergentagent.com/customer-dashboard")
