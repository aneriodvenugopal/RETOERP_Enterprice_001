...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://propmanager-41.preview.emergentagent.com/login")
    print("   Properties: https://propmanager-41.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://propmanager-41.preview.emergentagent.com/customer-dashboard")
