...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://propertyhub-43.preview.emergentagent.com/login")
    print("   Properties: https://propertyhub-43.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://propertyhub-43.preview.emergentagent.com/customer-dashboard")
