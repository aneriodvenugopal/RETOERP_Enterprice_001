...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://property-pulse-81.preview.emergentagent.com/login")
    print("   Properties: https://property-pulse-81.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://property-pulse-81.preview.emergentagent.com/customer-dashboard")
