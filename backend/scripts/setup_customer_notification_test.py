...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://plotmanager.preview.emergentagent.com/login")
    print("   Properties: https://plotmanager.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://plotmanager.preview.emergentagent.com/customer-dashboard")
