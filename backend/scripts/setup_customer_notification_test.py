...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://voterlist.preview.emergentagent.com/login")
    print("   Properties: https://voterlist.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://voterlist.preview.emergentagent.com/customer-dashboard")
