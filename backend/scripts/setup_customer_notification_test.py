...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://layout-manager.preview.emergentagent.com/login")
    print("   Properties: https://layout-manager.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://layout-manager.preview.emergentagent.com/customer-dashboard")
