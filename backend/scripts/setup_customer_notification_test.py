...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://realestate-mgmt-9.preview.emergentagent.com/login")
    print("   Properties: https://realestate-mgmt-9.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://realestate-mgmt-9.preview.emergentagent.com/customer-dashboard")
