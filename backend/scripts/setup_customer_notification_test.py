...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://realtyfinance.preview.emergentagent.com/login")
    print("   Properties: https://realtyfinance.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://realtyfinance.preview.emergentagent.com/customer-dashboard")
