...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://skilled-workforce.preview.emergentagent.com/login")
    print("   Properties: https://skilled-workforce.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://skilled-workforce.preview.emergentagent.com/customer-dashboard")
