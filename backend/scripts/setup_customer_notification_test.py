...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://land-atlas.preview.emergentagent.com/login")
    print("   Properties: https://land-atlas.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://land-atlas.preview.emergentagent.com/customer-dashboard")
