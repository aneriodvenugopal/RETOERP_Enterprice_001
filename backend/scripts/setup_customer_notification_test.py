...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://realty-manager-27.preview.emergentagent.com/login")
    print("   Properties: https://realty-manager-27.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://realty-manager-27.preview.emergentagent.com/customer-dashboard")
