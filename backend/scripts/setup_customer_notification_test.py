...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://villageprop.preview.emergentagent.com/login")
    print("   Properties: https://villageprop.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://villageprop.preview.emergentagent.com/customer-dashboard")
