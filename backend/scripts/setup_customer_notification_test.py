...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://realfusion-1.preview.emergentagent.com/login")
    print("   Properties: https://realfusion-1.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://realfusion-1.preview.emergentagent.com/customer-dashboard")
