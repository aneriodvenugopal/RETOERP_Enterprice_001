...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://propmanage-63.preview.emergentagent.com/login")
    print("   Properties: https://propmanage-63.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://propmanage-63.preview.emergentagent.com/customer-dashboard")
