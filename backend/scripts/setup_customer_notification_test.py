...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://explain-erp.preview.emergentagent.com/login")
    print("   Properties: https://explain-erp.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://explain-erp.preview.emergentagent.com/customer-dashboard")
