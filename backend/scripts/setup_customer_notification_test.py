...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://agent-commission-5.preview.emergentagent.com/login")
    print("   Properties: https://agent-commission-5.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://agent-commission-5.preview.emergentagent.com/customer-dashboard")
