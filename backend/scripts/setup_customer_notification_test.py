...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://tutorai-video-gen.preview.emergentagent.com/login")
    print("   Properties: https://tutorai-video-gen.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://tutorai-video-gen.preview.emergentagent.com/customer-dashboard")
