...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://property-tech-2.preview.emergentagent.com/login")
    print("   Properties: https://property-tech-2.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://property-tech-2.preview.emergentagent.com/customer-dashboard")
