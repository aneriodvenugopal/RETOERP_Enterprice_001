...
async def setup_customer_test():
    ...
    print("\n🔗 URLs:")
    print("   Login: https://proptech-hub-54.preview.emergentagent.com/login")
    print("   Properties: https://proptech-hub-54.preview.emergentagent.com/properties")
    print("   Customer Dashboard: https://proptech-hub-54.preview.emergentagent.com/customer-dashboard")
