...
async def create_satthenapalli_layout():
    ...
    print(f"https://erp-plotsystem.preview.emergentagent.com/public/layout/{project_id}")
    print(f"\nAuthenticated View:")
    print(f"https://erp-plotsystem.preview.emergentagent.com/projects/{project_id}/layout")
