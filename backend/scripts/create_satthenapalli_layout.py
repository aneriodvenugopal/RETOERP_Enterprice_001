...
async def create_satthenapalli_layout():
    ...
    print(f"https://estate-platform-6.preview.emergentagent.com/public/layout/{project_id}")
    print(f"\nAuthenticated View:")
    print(f"https://estate-platform-6.preview.emergentagent.com/projects/{project_id}/layout")
