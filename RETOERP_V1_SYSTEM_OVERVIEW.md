...
**Testing URL:** `https://whatsapp-leads-36.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://whatsapp-leads-36.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://whatsapp-leads-36.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://whatsapp-leads-36.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://whatsapp-leads-36.preview.emergentagent.com
```
