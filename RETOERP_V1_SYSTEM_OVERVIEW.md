...
**Testing URL:** `https://propertysuite-3.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://propertysuite-3.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://propertysuite-3.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://propertysuite-3.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://propertysuite-3.preview.emergentagent.com
```
