...
**Testing URL:** `https://realai-whatsapp.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://realai-whatsapp.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://realai-whatsapp.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://realai-whatsapp.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://realai-whatsapp.preview.emergentagent.com
```
