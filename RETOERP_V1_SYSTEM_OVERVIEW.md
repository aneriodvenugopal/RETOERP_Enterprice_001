...
**Testing URL:** `https://realapex-agentic-ai.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://realapex-agentic-ai.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://realapex-agentic-ai.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://realapex-agentic-ai.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://realapex-agentic-ai.preview.emergentagent.com
```
