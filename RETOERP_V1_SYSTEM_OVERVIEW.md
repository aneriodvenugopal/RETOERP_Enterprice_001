...
**Testing URL:** `https://explain-erp.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://explain-erp.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://explain-erp.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://explain-erp.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://explain-erp.preview.emergentagent.com
```
