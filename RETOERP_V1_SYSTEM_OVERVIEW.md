...
**Testing URL:** `https://realestate-erp-4.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://realestate-erp-4.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://realestate-erp-4.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://realestate-erp-4.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://realestate-erp-4.preview.emergentagent.com
```
