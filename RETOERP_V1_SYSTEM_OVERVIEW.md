...
**Testing URL:** `https://realestate-mgmt-9.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://realestate-mgmt-9.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://realestate-mgmt-9.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://realestate-mgmt-9.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://realestate-mgmt-9.preview.emergentagent.com
```
