...
**Testing URL:** `https://agentapex-build.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://agentapex-build.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://agentapex-build.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://agentapex-build.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://agentapex-build.preview.emergentagent.com
```
