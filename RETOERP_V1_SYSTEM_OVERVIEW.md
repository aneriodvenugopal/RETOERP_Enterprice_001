...
**Testing URL:** `https://land-atlas.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://land-atlas.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://land-atlas.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://land-atlas.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://land-atlas.preview.emergentagent.com
```
