...
**Testing URL:** `https://apex-mobile-ux.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://apex-mobile-ux.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://apex-mobile-ux.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://apex-mobile-ux.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://apex-mobile-ux.preview.emergentagent.com
```
