...
**Testing URL:** `https://whatsapp-agent-v2.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://whatsapp-agent-v2.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://whatsapp-agent-v2.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://whatsapp-agent-v2.preview.emergentagent.com/api/commissions/payouts`
...
### **Backend Base URL:**
```
https://whatsapp-agent-v2.preview.emergentagent.com
```
...
```
URL: https://whatsapp-agent-v2.preview.emergentagent.com
```
