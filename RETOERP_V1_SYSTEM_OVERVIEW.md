...
**Testing URL:** `https://prop-booking-1.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://prop-booking-1.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://prop-booking-1.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://prop-booking-1.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://prop-booking-1.preview.emergentagent.com
```
