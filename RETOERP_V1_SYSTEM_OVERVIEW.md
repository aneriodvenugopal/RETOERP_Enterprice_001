...
**Testing URL:** `https://agent-tools-2.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://agent-tools-2.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://agent-tools-2.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://agent-tools-2.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://agent-tools-2.preview.emergentagent.com
```
