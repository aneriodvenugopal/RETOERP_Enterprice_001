...
**Testing URL:** `https://realty-manager-27.preview.emergentagent.com/api/bank-accounts`
...
**Testing URL:** `https://realty-manager-27.preview.emergentagent.com/api/payment-transfer`
...
**Testing URL:** `https://realty-manager-27.preview.emergentagent.com/api/razorpay/*` and `/api/manual`
...
**Testing URL:** `https://realty-manager-27.preview.emergentagent.com/api/commissions/payouts`
...
```
URL: https://realty-manager-27.preview.emergentagent.com
```
