...
const FAQRealEstate = () => {
  ...
  const faqs = [
    {
      question: "How does RETOERP help avoid lead leakage and improve conversions?",
      answer: (
        <div className="space-y-3">
          <p>RETOERP's Anti-Leakage System ensures zero lead loss through:</p>
    ...
    },
    {
      ...
      answer: (
        <div className="space-y-3">
          <p>RETOERP automates time-consuming tasks:</p>
          <ul className="list-disc ml-6 space-y-2">
    ...
    {
      question: "Does RETOERP support video calling for virtual site visits?",
      answer: (
        <div className="space-y-3">
    ...
    {
      question: "How does RETOERP calculate commissions and manage agent payments?",
      answer: (
        <div className="space-y-3">
    ...
    {
      question: "What makes RETOERP 40X faster than traditional real estate operations?",
      answer: (
        <div className="space-y-3">
      ...
      <div className="container mx-auto px-6 py-12 max-w-5xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Learn how RETOERP transforms your business with automation, eliminates leakage, and accelerates growth
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 mb-12 text-white">
          ...
          <p className="text-lg opacity-90 mb-4">
            RETOERP helps you automate operations, eliminate revenue leakage, and grow 40X faster with:
          </p>
        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-700 mb-6">
            Join 500+ real estate companies using RETOERP to eliminate leakage and grow faster
          </p>
