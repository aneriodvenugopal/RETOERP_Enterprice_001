...
• Create payment vouchers</p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border-4 border-green-500">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-3xl font-bold text-gray-900">Automated with RETOERP</h2>
...
✅ Direct bank transfer</p>
        ...
        <div className="mt-16 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://wa.me/919948303060?text=I want to automate my operations with RETOERP!" target="_blank" rel="noopener noreferrer" className="inline-block bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-xl">
              💬 Chat on WhatsApp
            </a>
