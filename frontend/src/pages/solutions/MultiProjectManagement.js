          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-red-50 p-6 rounded-xl border-l-4 border-red-500">
                <h3 className="text-xl font-bold text-red-700 mb-4">Without RETOERP</h3>
              ...
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h3 className="text-xl font-bold text-green-700 mb-4">With RETOERP</h3>
                <ul className="space-y-2 text-gray-700">
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">RETOERP automatically manages leads, follow-ups, payments, reports, and visualizations for each project</p>
                </div>
              </div>
              <div className="flex gap-6">
                <div className="flex-shrink-0 w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold text-xl">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Join 500+ real estate businesses managing unlimited projects with RETOERP
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-center text-gray-600 mb-8">
              See how RETOERP can help you manage multiple projects seamlessly
            </p>
            <EnquiryForm />
          </div>
        </div>
