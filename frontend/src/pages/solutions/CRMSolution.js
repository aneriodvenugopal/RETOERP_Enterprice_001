        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-2xl text-white/90 mb-8">
              Stop losing 30-40% of your leads. RETOERP's intelligent CRM ensures 0% leakage with automated follow-ups and smart assignment.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <section className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">
                The Solution: RETOERP Smart CRM
              </h2>
            ...
            <section className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-8">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-600 text-white rounded-lg p-6">
                  <p className="text-xl font-bold mb-2">With RETOERP CRM:</p>
