    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h3 className="text-xl font-bold text-green-700 mb-4">RETOERP Automation</h3>
                <ul className="space-y-3 text-gray-700">
              ...
              {useCases.map((useCase, index) => (
                <div key={index} className="bg-gradient-to-r from-blue-50 to-cyan-50 p-8 rounded-xl border-l-4 border-blue-500">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <p className="text-sm font-semibold text-gray-600 mb-2">❌ Before RETOERP</p>
                      <p className="text-gray-700">{useCase.before}</p>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-gray-600 mb-2">✅ After RETOERP</p>
      ...
      <div className="py-16 bg-gradient-to-br from-blue-50 to-cyan-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-12">
              Why RETOERP Communication Works
            </h2>
