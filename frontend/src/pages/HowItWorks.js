        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-white mb-8 text-center">
              <h2 className="text-3xl font-bold mb-4">RETOERP + IncomeLands Partnership</h2>
              <p className="text-lg opacity-90">
                RETOERP is the <strong>Technical Partner</strong> powering IncomeLands' complete ecosystem
              </p>
            </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-red-500">
                ...
                <div className="mt-4 bg-red-50 p-4 rounded-lg">
                  <p className="text-sm text-red-800">
                    ✅ Every lead from every channel automatically captured in RETOERP<br/>
          ...
          <div className="lg:col-span-2">
            <DemoRequestForm 
              demoType="Complete RETOERP Ecosystem"
