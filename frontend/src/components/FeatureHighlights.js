        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 max-w-4xl mx-auto text-white">
            ...
            <p className="text-lg mb-6 opacity-90">
              Schedule a free demo to see how RETOERP benefits everyone in your organization
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="https://wa.me/919948303060?text=I want to see a demo of RETOERP for my organization"
                target="_blank"
