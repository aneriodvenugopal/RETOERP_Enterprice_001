      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="md:flex items-center justify-between">
                ...
                <div className="md:w-5/12 mb-6 md:mb-0 md:pl-12">
                  <div className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 backdrop-blur-sm rounded-xl p-8 border-2 border-cyan-500 shadow-2xl">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-3">Phase 4: RETOERP is Born!</h3>
                    <p className="text-white leading-relaxed mb-4">
                      Decision made: Build <strong>RETOERP</strong> - an <strong>advanced SaaS platform</strong> that combines everything we learned from dozens of successful implementations. One system that handles:
                    </p>
          ...
          <div className="mt-16 bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/30">
            <h3 className="text-3xl font-bold text-white mb-8 text-center">What Makes RETOERP Different?</h3>
