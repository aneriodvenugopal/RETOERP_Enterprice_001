...
const ROICalculator = () => {
  ...
  const calculateROI = () => {
    ...
    // With RETOERP (0% leakage, better conversion)
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Calculate Your ROI with RETOERP
          </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-500/20 backdrop-blur-lg rounded-2xl p-6 border-2 border-green-400">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-xl font-bold">✅ With RETOERP - Annual Gain</h3>
              ...
              <div className="bg-yellow-500/20 backdrop-blur-lg rounded-2xl p-6 border-2 border-yellow-400">
                <div className="text-center">
                  ...
                  <p className="text-sm text-white/80 mt-2">
                    RETOERP pays for itself in less than 1 month!
                  </p>
                </div>
              </div>
              ...
              {/* CTA */}
              <a
                href="https://wa.me/919948303060?text=I calculated my ROI and want to start with RETOERP!"
                target="_blank"
