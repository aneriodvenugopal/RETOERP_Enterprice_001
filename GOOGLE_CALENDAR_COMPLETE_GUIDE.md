...
4. Create OAuth 2.0 credentials:
   ...
   - Authorized redirect URIs:
     ```
     https://realai-whatsapp.preview.emergentagent.com/api/auth/google/callback
     ```
   - Click **CREATE**
...
GOOGLE_REDIRECT_URI=https://realai-whatsapp.preview.emergentagent.com/api/auth/google/callback
```
...
### 1. Test OAuth Flow:
```bash
curl https://realai-whatsapp.preview.emergentagent.com/api/auth/google/login
```
...
curl -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  https://realai-whatsapp.preview.emergentagent.com/api/auth/google/status
```

### 3. Create Calendar Event:
```bash
curl -X POST https://realai-whatsapp.preview.emergentagent.com/api/calendar/create-event \
...
```bash
curl -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  "https://realai-whatsapp.preview.emergentagent.com/api/calendar/events?view=today"
```
