...
4. Create OAuth 2.0 credentials:
   ...
   - Authorized redirect URIs: `https://retoerp-1.preview.emergentagent.com/api/auth/google/callback`
...
curl https://retoerp-1.preview.emergentagent.com/api/auth/google/login

# 2. Check connection status (requires JWT token)
curl -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  https://retoerp-1.preview.emergentagent.com/api/auth/google/status

# 3. Create calendar event
curl -X POST https://retoerp-1.preview.emergentagent.com/api/calendar/create-event \
...
curl -H "Authorization: Bearer YOUR_JWT_TOKEN" \
  "https://retoerp-1.preview.emergentagent.com/api/calendar/events?view=today"
```
