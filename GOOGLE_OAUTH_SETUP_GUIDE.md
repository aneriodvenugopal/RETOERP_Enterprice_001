...
1. **Login to RETOERP:**
   - Go to: https://propmanager-41.preview.emergentagent.com/login
   - Login with your credentials

2. **Go to Calendar Page:**
   - Navigate to: `/calendar`
   - Or type: `https://propmanager-41.preview.emergentagent.com/calendar`
...
1. **RETOERP కి Login అవ్వండి:**
   - వెళ్ళండి: https://propmanager-41.preview.emergentagent.com/login
   - మీ credentials తో login అవ్వండి

2. **Calendar Page కి వెళ్ళండి:**
   - `/calendar` కి navigate చేయండి
   - లేదా type చేయండి: `https://propmanager-41.preview.emergentagent.com/calendar`
